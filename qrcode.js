...
(function () {
	...
	var QRDataFactory = {
		create: function (data, inputMode) {
			var newData;
	 ...
	 *
	 * @private
	 * @param {Object} qrData (QRNumber|QRAlphanumeric|QR8bitByte)
	 * @param {Number} nCorrectLevel
	 * @return {Number} type
	 */
	function _getTypeNumber(qrData, nCorrectLevel) {
		var nType = 1;
		var length = qrData.getLength();
		var limitLength = QRCodeLimitLength[qrData.type];
	 ...
	 * @param {QRCode.InputMode} [vOption.inputMode=QRCode.InputMode] [MODE_8BIT_BYTE|MODE_NUMBER|MODE_ALPHA_NUM]
	...
	QRCode.prototype.makeCode = function (sText) {
		var qrData = QRDataFactory.create(sText, this._htOption.inputMode);
		this._oQRCode = new QRCodeModel(_getTypeNumber(qrData, this._htOption.correctLevel), this._htOption.correctLevel);
		this._oQRCode.addData(qrData);
		this._oQRCode.make();
